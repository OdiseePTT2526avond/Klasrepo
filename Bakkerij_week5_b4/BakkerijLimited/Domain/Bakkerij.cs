...
namespace BakkerijLimited.Domain
{
    ...
    public class Bakkerij
    {
        ...
        private readonly IKlantenkaartService _klantenkaartService;

        // Constructor, noodzakelijke initialisaties - tot nu toe
        public Bakkerij(IKlantenService klantenService, KlantenkaartService klantenkaartService)
        {
            // REQ0001
            ...
            _klantenkaartService = klantenkaartService;
        }
        ...
        public Klantenkaart MaakKlantenkaart()
        {
            ...
            // GeselecteerdeKlantenkaart = _klantenkaartenRepo.AddKlantenkaart(Klant);  -- oude versie
            GeselecteerdeKlantenkaart = _klantenkaartService.MaakKlantenkaart(Klant);
        ...
        {
            // Klantenkaart? gevonden = _klantenkaartenRepo.ZoekOpNummer(klantenkaartNummer); -- oude versie
            Klantenkaart? gevonden = _klantenkaartService.ZoekKlantenkaart(klantenkaartNummer);
        ...
        { 
            if (GeselecteerdeKlantenkaart is not null)
            {
                GeselecteerdeKlantenkaart.VoegBestellingToeAanKlantenkaart(BestellingInUitvoering!.Aantal);
                _klantenkaartService.UpdateKlantenkaart(GeselecteerdeKlantenkaart);
            }
        }
        ...
        public decimal BerekenKortingEnWerkBij()
        {
            if (GeselecteerdeKlantenkaart is not null)
            {
                BerekendeKorting = GeselecteerdeKlantenkaart.BerekenKortingEnWerkBij(BestellingInUitvoering!);
                _klantenkaartService.UpdateKlantenkaart(GeselecteerdeKlantenkaart);

...
namespace GradesHelper.Tests
{
    ...
    public class GradesHelperTests
    {
        ...
        [Test]
        public void AddScore_WithInvalidData_AddScoreNotCalled2()
        {
            //Arrange
            //Using a dummy to show that add is not called on the repository
            GradeRepositoryDummy dummy= new GradeRepositoryDummy();
            GradesHelper sut = new GradesHelper(dummy);
            Student s = null;

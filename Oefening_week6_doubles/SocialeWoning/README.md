...
## Opdracht
Gebruik TDD (uiteraard) om de requirements te implementeren. Omdat unit tests voor req02 ook testen of een kandidaat in aanmerking komt en dat een herhaling van req01 is, zal een test double gebruikt worden.

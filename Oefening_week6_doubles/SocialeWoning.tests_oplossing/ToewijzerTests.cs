...
{
    public class ToewijzerTests_interface
    {

        // Test double: Stub die altijd true teruggeeft (kandidaat komt in aanmerking)
        private class StubVoorwaardenCheckerTrue : IKandidaatChecker
        {
        ...
        private class StubVoorwaardenCheckerFalse : IKandidaatChecker
        {
            public bool VoldoetAanVoorwaarden(Kandidaat kandidaat)
            {
                return false;
